...
public class MCTSAgentBasic implements Agent{
    ...
    public MCTSAgentBasic(int agentId, RoundController roundController) {
        ...
        try {
            ...
            Node root = new Node(
                    NodeState.createRoundStateBasedOn(
                            ...
                            roundState.getPlayerHands().get(agentId),
                    ...
                    null,
                    new SmartAgent(0, null), maxDepth, agentId, false); // Change agent that is used for rollout here
